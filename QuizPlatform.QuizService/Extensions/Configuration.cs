...
using MediatR;
using QuizPlatform.QuizService.Behaviors;
using QuizPlatform.QuizService.Middleware;
using QuizPlatform.QuizService.Profiles;

namespace QuizPlatform.QuizService.Extensions;
